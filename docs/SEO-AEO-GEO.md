...
- Focus keyword (Search & AI ranking anchor)
- AI Auto-Generation: Title, meta_title, meta_description, and focus_keyword can be auto-generated by the AI Assistant during article drafting
- Cover → `og:image`
