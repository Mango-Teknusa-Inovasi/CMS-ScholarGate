...
export const RESOURCE_CONFIGS: Record<string, ResourceConfig> = {
  ...
  downloads: {
    ...
    description: 'Pusat dokumen resmi sekolah (PDF, Word, Excel, PPT, ZIP) atau link Google Drive/Cloud.',
    listPath: '/admin/downloads',
    fields: [
      { key: 'title', label: 'Judul Dokumen' },
      { key: 'description', label: 'Deskripsi', type: 'textarea' },
      { key: 'file_path', label: 'Berkas Dokumen / Link File', type: 'file' },
      { key: 'file_name', label: 'Nama file (opsional)' },
      { key: 'category', label: 'Kategori (contoh: Dokumen, Formulir, Kurikulum)' },
      { key: 'is_active', label: 'Aktif / Tampilkan di Portal', type: 'checkbox' },
    ],
  },
}
