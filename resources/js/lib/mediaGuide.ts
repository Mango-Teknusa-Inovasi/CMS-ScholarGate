...
export const MEDIA_GUIDES: MediaGuide[] = [
  {
    ...
    maxMb: 2,
    format: 'PNG / JPG / WebP',
    where: 'Admin → Pengaturan',
    tips: 'Satu unggahan otomatis menghasilkan logo header, favicon 16/32, apple-touch 180, dan OG default (jika kosong).',
  },
  {
    key: 'banner',
