...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Legal pages — body uses institution/site_name dynamically
        $orgName = (string) ($settings['site_name'] ?? LegalContent::institutionName());
        LegalPage::query()->delete();
        foreach (LegalContent::allDefaults($orgName) as $legal) {
            LegalPage::query()->create($legal);
        }
