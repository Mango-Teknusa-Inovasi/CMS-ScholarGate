    ...
    private function contentSecurityPolicy(Request $request): string
    {
        ...
        if ($this->isLocalDev($request)) {
            return implode('; ', [
                ...
                "frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://www.instagram.com https://instagram.com https://player.vimeo.com https://www.google.com https://maps.google.com https://open.spotify.com https://w.soundcloud.com",
                "object-src 'none'",
                "base-uri 'self'",
                "form-action 'self'",
