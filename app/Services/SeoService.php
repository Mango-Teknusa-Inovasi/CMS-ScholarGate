...
class SeoService
{
    ...
    public function pageMeta(string $path = '/'): array
    {
        ...
        $pages = [
            ...
            '/kebijakan-privasi' => [
                'title' => 'Kebijakan Privasi | '.$site,
                'description' => 'Kebijakan privasi dan perlindungan data pada portal '.$site.'.',
            ],
            '/syarat-ketentuan' => [
                'title' => 'Syarat & Ketentuan | '.$site,
                'description' => 'Syarat dan ketentuan penggunaan portal '.$site.'.',
            ],
        ];
